...
<main class="flex flex-col min-h-screen px-4 pt-20 ml-0 transition-all duration-300 sm:ml-64">
    <section class="mt-8 max-w-7xl">
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-3xl font-bold text-gray-800 sm:text-4xl">Referrals Management</h2>
                    ...
                    <?php if (!empty($referrals)): ?>
                        <?php foreach ($referrals as $row): ?>
                            <tr class="hover:bg-gray-50">
                                <td class="p-3 text-center border"><?= htmlspecialchars($row['ticket_id']) ?></td>
                                <td class="p-3 border"><?= htmlspecialchars($row['student_name']) ?></td>
                                <td class="p-3 border"><?= htmlspecialchars($row['college']) ?></td>
                                <td class="p-3 border"><?= htmlspecialchars($row['referrer_name']) ?></td>
                                <td class="p-3 border"><?= htmlspecialchars($row['position']) ?></td>
                                <td class="p-3 border"><?= htmlspecialchars($row['reason']) ?></td>
                                <td class="p-3 text-center border">
                                    <a 
                                        href="edit_referral.php?id=<?= $row['ticket_id'] ?>" 
                                        class="text-blue-600 hover:underline"
                                    >Edit</a> | 
                                    <a 
                                        href="delete_referral.php?id=<?= $row['ticket_id'] ?>" 
