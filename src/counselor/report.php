...
<div class="flex flex-col min-h-screen px-4 pt-20 ml-0 transition-all duration-300 sm:ml-64">
    <section class="mt-8">
        ...
        <!--ASSESSMENT CHART-->
        <h2 class="my-5 mt-5 text-4xl font-bold text-gray-700">Assessment Overview</h2>
            <div class="p-6 bg-white rounded-lg shadow">
                <div class="grid grid-cols-3 gap-4 mb-4">
                    <div>
                        <h2 class="p-3 my-2 text-3xl font-semibold text-center text-gray-800">College/Institute</h2>
                        <div class="w-[350px] h-[300px] mx-auto">
                            <canvas id="college-instituteChart"></canvas>
                        </div>
                    </div>
...
const messageButton = document.getElementById('messageButton');
    ...
    // Show chat odal when message icon is clicked
